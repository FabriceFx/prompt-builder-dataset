        ...
        <div class="max-w-6xl mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div class="flex items-center gap-3">
                ...
                <a href="https://paypal.me/FFaucheux" target="_blank" class="flex items-center gap-2 px-4 py-2 bg-slate-50 text-slate-500 border border-slate-200 rounded-xl text-xs font-bold hover:bg-yellow-50 hover:text-yellow-700 hover:border-yellow-200 transition-all duration-300">
                    <i class="fas fa-mug-hot"></i> <span data-translate="tip" class="hidden sm:inline">Offrir un café</span>
                </a>
            </div>
        </div>
    </header>
    ...
    <script>
        const texts = {
            fr: {
                ...
                how_step3_title: "3. Obtiens une réponse pro", how_step3_text: "Copie le résultat optimisé et colle-le dans Gemini, ChatGPT ou Claude pour un résultat parfait.",
            ...
            en: {
                ...
                how_step3_title: "3. Get pro results", how_step3_text: "Copy the optimized prompt into Gemini, ChatGPT or Claude to get the perfect answer.",
